...
public class PayController extends BaseService{
    ...
    public Result<?> createPay(String orderId) throws IOException, GeneralSecurityException, HttpCodeException, NotFoundException {
        ...
        instance.putMerchant("1630776473", new WechatPay2Credentials("1630776473", new PrivateKeySigner("39942C80816A9156CC0556691CB36326CAFA3849", WxUtils.getPrivateKey())), "a00c362d61f7f7beabfd5976302babea".getBytes(StandardCharsets.UTF_8));
        Verifier verifier = instance.getVerifier("1630776473");
        WechatPayHttpClientBuilder builder = WechatPayHttpClientBuilder.create().withMerchant("1630776473", "39942C80816A9156CC0556691CB36326CAFA3849", WxUtils.getPrivateKey()).withValidator(new WechatPay2Validator(verifier));
        ...
        rootNode.put("mchid","1630776473")
                .put("appid", "wx10031f70ad3e229c")
